...
public class MarketplaceServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        if ("addCourse".equals(action)) {
            ...
            String[] days = request.getParameter("days").split(",");
            ...
            try {
                ...
                System.out.println("Executing query: " + querySql + " with userID: " + userID);
                ResultSet rs = queryPs.executeQuery();
    
                String contact = null;
                if (rs.next()) {
                    contact = rs.getString("email");
                    System.out.println("Found user email: " + contact);
                } else {
                ...
                // Get the generated schedID
                ResultSet generatedKeys = ps.getGeneratedKeys();
                int schedID = -1;
                if (generatedKeys.next()) {
                    schedID = generatedKeys.getInt(1);
                }
                ...
                ps2.setInt(1, userID);
                ps2.setInt(2, schedID);
                ps2.setString(3, "owned");

                int rowsAffected2 = ps2.executeUpdate();
                
                if (schedID > 0 && rowsAffected2 > 0) {
